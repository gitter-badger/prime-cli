...
import {DepsIndex, PrimeProject, StreamAnalyzer} from 'prime-build';
...
export class PrefetchTransform extends Transform {
  ...
  constructor(project: PrimeProject) {
